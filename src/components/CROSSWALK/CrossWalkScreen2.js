...
export const CrossWalkScreen2 = ({fetchCrosswalkEntryData,
        ...
        <Container>
          ...
          <Row>
            ...
            <Tabs>
                ...
                <Card>
                  <Card.Body>
                    ...
                    */}
                      ...
                      <Row>
                        <Col sm={12}>
                          <label>All Employees for selected school</label>
                        </Col>
                      </Row>
              ...
              <Tab
                eventKey="CrosswalkedPositions"
                title="Crosswalked Positions"
              >
                <Card>
                  <Card.Body>
...
export default connect(mapStateToProps,{fetchCrosswalkEntryData,
                                        ...
                                        checkForDuplicateCrosswalkRecord,
                                        fetchEmployeeData,
                                        fetchEmployeeIDSBySchoolName})(CrossWalkScreen2);
