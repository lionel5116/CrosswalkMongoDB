...
function ModalForEditEmployee(props) {
  ...
  return (
    <div>
      ...
      >
        ...
        <Modal.Body>
          <Form>
            ...
            <Row>
              <Col sm={6}>
              <Form.Label
              style={{width:'100px'}}>Position</Form.Label>
                <input
                  id={props.Position}
                  style={styles.modalInputSyle.empIDTextField}
            ...
            <Row>
              <Col sm={12}>
              <Form.Label>Select New Position</Form.Label>
        ...
        <Modal.Footer>
          <Button variant="warning" onClick={(e) => UpdateCrosswalkRecord(e)}
...
export default ModalForEditEmployee;
